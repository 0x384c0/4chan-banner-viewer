...
//неидимые
for(q=0;q<30;q++){document.getElementsByClassName("yise")[q].style.visibility = "hidden" ;}
//анимация
function chinAnime(){
...
for(q=0;q<30;q++){document.getElementsByClassName("yise")[q].style.visibility = "visible" ;}
anim=1;
}
else {
